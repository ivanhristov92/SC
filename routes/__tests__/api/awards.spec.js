...
const Awards = require('../../api/awards');
...
describe('Awards module', () => {
	const cleanAwards = (done) => {
		Awards.model.find({})
		.remove(function(err) {
			done();
		});
	...
	const saveAnAward = (model)=> {
		return new Promise((resolve, reject) => {
			return new Awards.model(model).save(err => {
	...
	describe('it should export a "list" function', () => {
		...
		beforeEach(cleanAwards);

		it('should export a "list" function', () => {
			expect(Awards.list).to.be.a("Function")
		});
